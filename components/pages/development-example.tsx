...
const reqParam = [
  { var: 'productCode', type: 'string', value: 'S2', value2:'BBSDN' },
  { var: 'destination', type: 'string', value: '08123456789000', value2:'08123456789000' },
  { var: 'referenceId', type: 'string', value: '<anything unique>', value2: '<anything unique>'},
  { var: 'amount', type: 'integer', value: '-', value2: "10000" },
]
